...
extension Notification.Name {
    static let clawChatThemeDidChange = Notification.Name("ClawChatThemeDidChange")
    static let clawChatAppearanceDidChange = Notification.Name("ClawChatAppearanceDidChange")
}
