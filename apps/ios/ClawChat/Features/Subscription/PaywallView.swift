...
struct PaywallView: View {
    ...
    private let termsURL = URL(string: "https://clawchat.candiapps.com/terms.html")
    private let privacyURL = URL(string: "https://clawchat.candiapps.com/privacy.html")
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(String(localized: "ClawChat Plus"))
    ...
    private var heroCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Use ClawChat with your own Cloudflare R2 relay. Normal ClawChat usage stays within Cloudflare R2's free tier, so there is no extra R2 cost for typical use.")
    ...
    private func productDetailText(for product: Product) -> String {
        switch product.id {
        case SubscriptionController.yearlyProductID:
            return String(localized: "Best price if you use ClawChat regularly")
        case SubscriptionController.monthlyProductID:
